...
**Приоритет:** высокий — **до демо** (~30 мин)
...
### [DOC-004] Конвенция тегов для релизов DF
**Источник:** устное обсуждение 2026-05-13
**Суть:** Применить ту же идею slug@version к самому DF — теги на коммитах по версиям (v0.13, v0.14…).
Подумать: правила расстановки, когда тегировать, как это соотносится с Chronicle для DF.
**Приоритет:** низкий — после демо

---

 Chronicle — умный поиск таблицы версий в README
**Источник:** устное обсуждение 2026-05-12
