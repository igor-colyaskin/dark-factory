...
Текущий вектор: углубление IC-профиля (Smart Input → Square 2).
...
- **OData metadata reader** — Architect запрашивает `$metadata` → точные PascalCase имена и типы, clarify-раунд исчезает. Приоритет если выбирать одно среди IC-дополнений.
